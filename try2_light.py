...
if __name__ == "__main__":
    ...
    try:
        ...
        datapath = '/cta/users/ftasyaran/NLPC/training-data-master/'
        sentences_dict = {}
    ...
    for epoch in range(EPOCHS):
        train(epoch, model, optimizer, training_loader)
    ...
    for epoch in range(EPOCHS):
      ...
      print(classification_report(targets,outputs,target_names=label_cols,zero_division=1))
      #for i in range (len(outputs)):
          #print('output: ', outputs[i], 'target: ',targets[i])
